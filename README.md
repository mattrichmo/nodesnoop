...
The app uses a spruce tree menu bar icon and keeps the menu organized into status, processes, bulk actions, and application sections. Each process has actions to open Terminal at its working directory, copy its PID, or kill it. The menu also includes a kill-all action.
